...
let store: StoreType = {
    ...
    // _addNewPost() {
    //     const newPost: PostType = { id: v1(), message: this._state.profilePage.inputValue }
    //     const newState: AppStateType = { ...this._state };
    //     newState.profilePage.posts = [newPost, ...newState.profilePage.posts,]
    //     newState.profilePage.inputValue = ''
    //     this._state = { ...newState }

    //     store._subcriber()
    // },
    // _changeValue(post: string) {
    //     this._state.profilePage.inputValue = post
    //     this._subcriber()
    // },
